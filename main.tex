...
\begin{itemize}[noitemsep, topsep=1pt]
    \item\setstretch{1.2} Reorganized VLSI design for peripheral interfaces and data pipeline for the previously taped-out \href{https://www.cs.yale.edu/homes/abhishek/ksriram-isca20.pdf}{HALO}, a neural-processor ASIC (BCI) accelerating Intan-based signal processing to 46 Mbps under an ultra-low-power budget.
\end{itemize} \vspace{0.7ex}
