...
\usepackage[margin=0.53in, top=0.6in]{geometry}
\usepackage{enumitem}
\usepackage{hyperref}
\usepackage{setspace}
\usepackage{tabularx}
...
\setlength\itemsep{-0.4em}
    \item\setstretch{1.2} \textbf{Relevant Coursework (GPA 3.65/4):} Computer Architecture (EE)$^{\dag}$, Introduction to VLSI System Design (EE), FPGA-Based Acceleration, Big Data Systems (Disaggregated Infra), Computer Networks, Building Distributed Systems, Design and Implementation of Operating Systems$^{\dag}$, Principles of Computer System Design.
\end{itemize}
...
\noindent\begin{tabular*}{\textwidth}{@{\extracolsep{\fill}} l r @{}}
    ...
    \textit{Technologies:} & AWS/GCP; K8s; Linux; eBPF/LKM; Xilinx (Vivado, Vitis); Yocto; Terraform; git\vspace{0.2em} \\
...
% \noindent\textbf{Big-Data Systems Thesis}, Yale Computer Systems Lab (Prof. Khandelwal) \hfill \textit{July 2025 – Present} 
% \begin{itemize}[noitemsep, topsep=1pt]
%     \item \setstretch{1.2} 
%     % \item\setstretch{1.2} Reorganized VLSI design for peripheral interfaces and data pipeline for the previously taped-out \href{https://www.cs.yale.edu/homes/abhishek/ksriram-isca20.pdf}{HALO}, a neural-processor ASIC accelerating Intan-based signal processing to 46 Mbps under an ultra-low-power budget.
...
\begin{itemize}[noitemsep, topsep=1pt]
    \item\setstretch{1.2} Developed ASIC-based FFT accelerators and extended peripheral testing interfaces for a pipelined neural-processor ASIC (12nm CMOS), resolving critical bottleneck in real-time PSD and frequency-domain decoding of neural signals.
    \item\setstretch{1.2} HALO is the first-of-its-kind GALS-style distributed neural-processor, uniquely achieving 46 Mbps throughput under an ultra-low-power budget (<15 mW); its reconfigurable accelerator clusters support multiple BCI workloads.  
...
\noindent{\textbf{\textbf{FPGA Research Intern}}, Yale Efficient Computing Lab (Prof. Lin Zhong) \href{https://antonmel.com/public/helios.png}{[View]}
\hfill \textit{Jan 2024 - August 2025 [1.5 year]}
\begin{itemize}[topsep=1pt]
\setlength\itemsep{-0.3em}

    \item \setstretch{1.2} Set up and implemented a Vivado PS/PL design for a QEC decoding system that overcomes real-time resource constraints of 100 logical qubit decoding using a distributed GTX Aurora SFP+ network across 5 Xilinx VMK180 FPGAs.
    \item \setstretch{1.2}Partnered with Xilinx to co-develop a scalable SoC management tool for remote virtual file system based deployment of Versal/UltraScale+ FPGAs, enabling Linux runtime (without reboot) reconfiguration with A/B image fallback.
\end{itemize}
...
\setlength\itemsep{-0.2em}
    \item\setstretch{1.2} Developed rWeensyOS (5k+ LOC), a minimal POSIX-compatible teaching microkernel in memory-safe Rust with intuitive PA-to-VA memory visualization; adopted as part of Yale's core systems course in Spring 2024.
...
\noindent{\textbf{\textbf{Drone Embedded Engineer}}, Iron Flight (Ukraine Humanitarian R\&D)
\setstretch{1.2}
...
\vspace{-2ex}
\section*{\vspace{0ex}\textcolor{gray}{\rule[0ex]{0em}{0ex}}\hspace{0em}\normalsize\textnormal{\textcolor{darkgray}{OPEN SOURCE}}\hspace{0.7em}\textcolor{customcolor}{\rule[0.5ex]{\dimexpr\linewidth-8em}{0.5pt}}\vspace{-2ex}}
...
\noindent\textbf{CPU with Speculative OoO Execution}, Computer Architecture \href{https://github.com/anton-mel/OoO-PARCv2/tree/main}{[View]} \hfill \textit{March 2025 – May 2025 [2 month]}
\begin{itemize}[noitemsep, topsep=1pt]
...
\setlength\itemsep{-0.3em}
  ...
  \item \setstretch{1.1} Programmed Teensy 4.1 for GPIO control, TDMA radio protocol, and implemented MOSFET power distribution.
\end{itemize}
