...
\setlength\itemsep{-0.4em}
    \item\setstretch{1.2} \textbf{Relevant Coursework (GPA 3.65/4):} Computer Networks, Building Distributed Systems, Big Data Systems (Disaggregated Infra), Computer Architecture (EE)$^{\dag}$, Introduction to VLSI System Design (EE), FPGA-Based Acceleration, Design and Implementation of Operating Systems$^{\dag}$, Principles of Computer System Design.
\end{itemize}
...
\begin{itemize}[noitemsep, topsep=1pt]
    \item\setstretch{1.2} Contributed to VLSI design restructuring for peripheral interfaces and data pipelines on the previously taped-out neural-processor ASIC (BCI) supporting Intan-based signal processing at 46 Mbps under an ultra-low-power budget.
    \item\setstretch{1.2} Developing ASIC-based FFT accelerators for implanted BCI applications, including Verilog implementation, physical synthesis in 12nm CMOS, and evaluation of area, power, and latency for an upcoming paper submission.
...
\setlength\itemsep{-0.3em}
    ...
    \item \setstretch{1.2}Partnered with Xilinx to co-develop a scalable SoC management tool for remote virtual file system based deployment of Versal/UltraScale+ FPGAs, enabling Linux runtime reconfiguration with A/B fallback.
\end{itemize}
...
%   \item \setstretch{1.2} Programmed Teensy 4.1 for GPIO control, TDMA radio protocol, and implemented MOSFET power distribution.
% \end{itemize}
